...
public class Main {
    ...
    public void test_monitor_sys() {
        ...
        String appAuthToken = "qHGpUsAmtUuJU6HuBvyBMA==";//根据真实值填写
        ...
        AlipayHeartbeatSynRequestBuilder builder = new AlipayHeartbeatSynRequestBuilder()
            ...
            .setNetworkType("LAN").setProviderId("2088102172477098") // 设置系统商pid
    ...
    public void test_trade_pay(AlipayTradeService service) {
        ...
        String sellerId = "2016082100308172";
        ...
        String providerId = "2088102172477098";
    ...
    public void test_trade_precreate() {
        ...
        // 业务扩展参数，目前可添加由支付宝分配的系统商编号(通过setSysServiceProviderId方法)，详情请咨询支付宝技术支持
        ExtendParams extendParams = new ExtendParams();
        extendParams.setSysServiceProviderId("2088102172477098");
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                String filePath = String.format("~/Desktop/qr-%s.png",
