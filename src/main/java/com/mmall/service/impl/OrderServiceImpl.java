...
/**
 * Created by sooszy on 2017/11/20.
 */
...
public class OrderServiceImpl implements IOrderService {
    ...
    private OrderVo assembleOrderVo(Order order, List<OrderItem> orderItemList) {
        ...
        orderVo.setImageHost(PropertiesUtil.getProperity("ftp.server.http.prefix"));
    ...
    public ServerResponse getOrderCartProduct(Integer userId) {
        ...
        orderProductVo.setImageHost(PropertiesUtil.getProperity("ftp.server.http.prefix"));
    ...
    public ServerResponse pay(Long orderNo, Integer userId, String path) {
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
                ...
                .setNotifyUrl(PropertiesUtil.getProperity("alipay.callback.url"))//支付宝服务器主动通知商户服务器里指定的页面http路径,根据需要设置
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                String qrUrl = PropertiesUtil.getProperity("ftp.server.http.prefix") + targetFile.getName();
